...
(function () {
  ...
  function initFloatingDragon() {
    ...
    style.textContent =
      '#vietnam-lotus{position:fixed;right:0;bottom:-2px;width:clamp(100px,10vw,158px);z-index:6;pointer-events:none;user-select:none;opacity:.34;filter:drop-shadow(0 5px 10px rgba(16,24,40,.06));}' +
      ...
      '@media(max-width:900px){#vietnam-lotus{width:87px;opacity:.30}#floating-dragon{width:82px;opacity:.80}}' +
      '@media(max-width:640px){#vietnam-lotus{width:60px;right:0;bottom:0;opacity:.26}#floating-dragon{display:none!important;}}' +
